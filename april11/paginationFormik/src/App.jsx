...
function App() {
  ...
  return (
    <div className="flex flex-col items-center space-y-6 px-4 py-10 bg-gray-100 min-h-screen">
      ...
      <div className="flex text-4xl w-full cursor-pointer justify-center items-center"><span onClick={goBack}>⬅️</span> <span>{pageNum==-1?setPageNum(0):pageNum/10}</span> <span onClick={goforward}>➡️</span></div>
    </div>
  );
}
